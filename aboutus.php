		    ...
		    <div class="navbartop">
		      <span id="myheader"><a href="homePage.php">cooking
		          <img src="https://image.flaticon.com/icons/svg/45/45200.svg" height="35px" alt="logo"></a>
					...
					<b>
		<a href="aboutus.php?dollar=true" style="width:auto;">
						<button type="button" name="dollar" style="width:30px;">	$</button></a>
						<a href="aboutus.php?euro=true" style="width:auto;">
						<button type="button" name="euro" style="width:30px;">&#8364;</button></a>
						<a href="aboutus.php?shekel=true" style="width:auto;">
...
<!-- all of the info of recipe -->
        ...
        <div class="photoplus">
          <p>The cooking project is a web course project.
            the purpose of this site is: you choose the recipe, we send you the the ingridients and you cook as you like!
          <br>  </p>

        <p>The crew of this site contain two memebers; Inbar Shartz and Amir Binenfeld</p>
        <label style="font-family: 'Playfair Display', serif; font-size:18pt;">Inbar Shwartz</label>
        <p>Inbar Shwatz is a 3rd year Information Systems student at the University of Haifa. Her goal is to get maximum points on this project and improve her grades. </p>
				<a href="https://www.linkedin.com/in/inbar-shwartz-b90180152/">Linkedin Profile</a>
				<br>
				<a href="https://www.instagram.com/inbar_shwartz/">Instagram Profile</a>
