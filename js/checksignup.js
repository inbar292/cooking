...
function fName_validation(finame) {
  var finame_len = finame.length;
  if (finame_len == "" || finame_len == null) {
    document.getElementById("Fname").style.borderColor = "red";
...
function sName_validation(sname) {
  ...
  if (sname_len == "" || sname_len == null) {
    document.getElementById("Sname").style.borderColor = "red";
    document.getElementById("SerrorMessage").innerHTML = "First name should be filled";
    return false;
  } else {
    document.getElementById("SerrorMessage").innerHTML = "";
    if (sname_len < 2) {
      document.getElementById("Sname").style.borderColor = "red";
      document.getElementById("SerrorMessage").innerHTML = "First name should be more than 2 characters";
      return false;
    }
