			    ...
			    <div class="navbartop">
			      <span id="myheader"><a href="homePage.php">cooking
			          <img src="https://image.flaticon.com/icons/svg/45/45200.svg" height="35px" alt="logo"></a>
						...
						<b>
			<a href="mrissoto.php?dollar=true" style="width:auto;">
							<button type="button" name="dollar" style="width:30px;">	$</button></a>
							<a href="mrissoto.php?euro=true" style="width:auto;">
							<button type="button" name="euro" style="width:30px;">&#8364;</button></a>
							<a href="mrissoto.php?shekel=true" style="width:auto;">
        ...
        while($row = $result->fetch_assoc()) {
          ...
          echo "<div class=photo>
            ...
            echo "  </div> </div>
										...
										echo "&nbsp&nbsp&nbsp<a href=mrissoto.php?addToCart=true style=width:auto; ><button type=button name=button style=width:220px;height:40px; >add to cart</button></a>";
										echo "</div><p></p>";
...
<div id="commentSection" class="comments">
  <h2>Comments</h2>
    ...
    <form id="ratingform" action="mrissoto.php" enctype="multipart/form-data" method="POST">
         ...
         while($row = $result->fetch_assoc()) {
            ...
            if($row['commPhoto']!=null && $row['commPhoto']!="images/"){
                echo "<img src=".$row['commPhoto']." height=300 width=400 /> <br> <p></p>";
						...
						//reply
						echo "<form id=form$commentID action=mrissoto.php enctype=multipart/form-data  method=POST>";
